<?php
    ...
    $data = $product->getProduct("shirt");
    shuffle($data);
    if (isset($_POST['shirt-cart'])) {
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="small-image pt-4 pb-4">
                                ...
                                <div class="slide-images owl-carousel">
                                    <?php foreach ($data as $item): ?>
                                        <div class="slide">
                                            <div class="slide-img set-bg" data-setbg="<?php echo $item["item_image"] ?? "product-image" ?>">
                                                <div class="view">
                                                    <form method="post">
                                                        ...
                                                        <?php
                                                            if (isset($_SESSION['id'])) {
                                                                if (in_array($item['item_id'], $cart->getCartId($cart->selectCart($_SESSION['id'])) ?? [] )) {
                                                                    echo '<button type="submit" name="shirt-cart" disabled class="btn bg-success d-flex justify-content-center h-100 mr-1 rounded-0"><i class="fa fa-shopping-bag"></i></button>';
                                                                }else{
                                                                    echo '<button type="submit" name="shirt-cart" class="btn bg-warning d-flex justify-content-center h-100 mr-1 rounded-0"><i class="fa fa-shopping-bag"></i></button>';
                                                                }
                                                            }else{
                                                                echo '<button type="submit" name="shirt-cart" class="btn bg-warning d-flex justify-content-center h-100 mr-1 rounded-0"><i class="fa fa-shopping-bag"></i></button>';
                                                            }
                        ...
                        <div class="col-lg-3 offset-lg-1 p-0">
                            <div class="large-image set-bg" data-setbg="images/shirts/black/black1.jpg">
                                <h3>Shirt</h3>
